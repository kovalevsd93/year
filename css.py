...
.hero-sub{font-size:clamp(16px,1.4vw,18.5px);color:var(--ink-2);max-width:36ch;line-height:1.68}
...
.hero-meta{font-size:13.5px;color:var(--ink-3);display:flex;flex-direction:column;
