   ...
   <figure class="hero-figure">
     ...
     <figcaption class="cred">
       ...
       <div class="cred-stats">
         <div><b>{YEARS_IN_PRACTICE} лет</b><span>практики</span></div>
         <div><b>100 000+</b><span>человек</span></div>
         <div><b>30+</b><span>книг</span></div>
       </div>
     </figcaption>
   </figure>
  </div>
...
<section class="sec sec-alt">
 <div class="wrap stack stack-l">
  {heading('Четыре уровня работы',
           ...
           'С помощью научно обоснованных методов мы помогаем глубоко проработать тревожные '
           'расстройства на уровне эмоций, тела, мыслей и поведения, чтобы вы могли получить '
           'устойчивый результат и освободиться от типичных проявлений тревоги.')}
...
<section class="sec price-sec" id="order">
 ...
 <div class="wrap stack stack-l">
  {heading('Условия', 'Знания и методики, которые меняют жизнь',
           f'Подписка на 1 год (365 дней) на библиотеку всех программ по преодолению тревожных '
           f'расстройств и неврозов. Акционное предложение действует до {DEADLINE_TEXT}.',
           wide=True)}
